...
::: info
事前にロードコマンドでロードし、実行する場合は
オンにすることでより効果的にロードすることができます。
...
- **開始時間 / 終了時間**
    ...
    また、右の<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><title>skip-next</title><path d="M16,18H18V6H16M6,18L14.5,12L6,6V18Z" fill="white" /></svg>ボタン及び<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"><title>skip-previous</title><path d="M6,18V6H8V18H6M9.5,12L18,6V18L9.5,12Z" fill="white" /></svg>ボタンをクリックすることで、先頭と末尾の無音時間をスキップすることができます。

- **波形表示**

    音声の波形を表示します。
    左の青い線が開始時間、右の青い線が終了時間を示しています。
    青い線をドラッグすることで開始時間、終了時間を設定することができます。

    また、カーソルを合わせると、カーソルが指している部分の音声内の時間が表示されます。

    実行中は黄色の線によって再生されている箇所が表示され、波形内の任意の位置をクリックすることで再生位置をクリックした位置に変更することができます。

- **音量変化**

    曲の途中で音量を変化させる機能です。
    「音量変化を表示」ボタンで、波形表示に表示するかを切り替えられます。

    ![alt text](image.png)

    音量変化は音量が一定の複数の区間（実線の横棒）と、それをつなぐ線で構成されています。

    区間は横棒の部分をドラッグすることで上下に動かして音量を変える事ができます。
    また、開始点、終了点の点をドラッグすることで左右に動かし、その音量の区間の開始点、終了点を設定できます。

    また、クリックすることで区間を選択することができます。

    そして、波形表示の右側にあるボタンは次のような機能を持っています。

    - <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20"><title>plus-circle-outline</title><path d="M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,7H11V11H7V13H11V17H13V13H17V11H13V7Z" fill="green"/></svg> 新たに区間を追加する。
    - <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20"><title>minus-circle-outline</title><path d="M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7,13H17V11H7" fill="red" /></svg> 選択した区間を削除する
    - <svg xmlns="http://www.w3.org/2000/svg" viewBox="-4 -4 32 32" width="20"><title>trash-can</title><circle cx="12" cy="12" r="14" fill="none" stroke="white"/><path d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M9,8H11V17H9V8M13,8H15V17H13V8Z" fill="white" /></svg> すべての区間を削除する
