    ...
    <div v-show="selectedCue != null && selectedCue.params.type == 'audio'">
      ...
      >
        <v-tab
          ...
          value="basics"
        >
          {{ t('main.bottomEditor.basics.title') }}
        </v-tab>
        <v-tab
          density="compact"
          value="audio"
