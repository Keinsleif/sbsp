...
export default defineConfig({
  ...
  define: {
    ...
    __IS_REMOTE__: JSON.stringify(
      process.env.VITE_APP_TARGET === 'websocket' || process.env.VITE_APP_SIDE === 'remote',
    ),
    __IS_HOST__: JSON.stringify(
      process.env.VITE_APP_TARGET !== 'websocket' && process.env.VITE_APP_SIDE === 'host',
    ),
  },
